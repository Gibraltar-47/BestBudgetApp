      ...
      <div className="mt-8 rounded-[24px] bg-white/95 p-5 shadow-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          <div>
            ...
            <input value={username} onChange={(e) => setUsername(e.target.value)} required className="w-full rounded-xl border border-[#d8dfda] px-4 py-3 outline-none focus:border-[#3d9b5d]" placeholder="moneyMaker123" />
          </div>
          <div>
