      ...
      <div className="px-4 py-5">
        ...
        <div className={`rounded-[28px] ${panel} shadow-sm p-4`}>
          <div className="mx-auto h-[280px] w-full max-w-[300px]">
            ...
            <div className="pointer-events-none -mt-[180px] text-center">
              <div className="text-[14px] text-[#6a7b70]">{language === 'fr' ? 'Budget mensuel' : 'Monthly Budget'}</div>
              <div className="text-[34px] font-extrabold">{formatMoney(currentBudget.monthlyBudget, currency)}</div>
              <div className="mt-1 text-[15px] text-[#6a7b70]">{language === 'fr' ? 'Dépensé' : 'Spent'}</div>
              <div className="text-[26px] font-bold text-[#d95b62]">{formatMoney(totalSpent, currency)}</div>
              <div className="mt-1 text-[15px] text-[#6a7b70]">{language === 'fr' ? 'Restant' : 'Remaining'}</div>
              <div className="text-[26px] font-bold text-[#3d9b5d]">{formatMoney(remaining, currency)}</div>
            </div>
          </div>
